(function(){var P$=Clazz.newPackage("javax.json"),I$=[[0,'javax.json.spi.JsonProvider']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
;Clazz.setTVer('3.3.1-v4');//Created 2022-03-19 05:26:00 Java2ScriptVisitor version 3.3.1-v4 net.sf.j2s.core.jar version 3.3.1-v4
