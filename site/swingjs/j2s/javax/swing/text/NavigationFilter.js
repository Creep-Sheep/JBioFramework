...
/*c*/var C$=Clazz.newClass(P$, "NavigationFilter", function(){
Clazz.newInstance(this, arguments,0,C$);
});
C$.$classes$=[['FilterBypass',1033]];
...
;
(function(){/*c*/var C$=Clazz.newClass(P$.NavigationFilter, "FilterBypass", function(){
...
;Clazz.setTVer('3.3.1-v4');//Created 2022-03-19 05:26:22 Java2ScriptVisitor version 3.3.1-v4 net.sf.j2s.core.jar version 3.3.1-v4
