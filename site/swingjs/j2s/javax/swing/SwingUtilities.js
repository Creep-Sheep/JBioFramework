...
if (t != text && (ui.textNode.innerHTML != t ||false) ) $I$(9).setAttr(ui.textNode, "innerHTML", t);
...
text=$I$(10).clipString$javax_swing_JComponent$java_awt_FontMetrics$S$I(c, fm, text, availTextWidth);
textR.width=$I$(10).stringWidth$javax_swing_JComponent$java_awt_FontMetrics$S(c, fm, text);
...
;Clazz.setTVer('3.3.1-v1');//Created 2021-05-28 11:33:56 Java2ScriptVisitor version 3.3.1-v1 net.sf.j2s.core.jar version 3.3.1-v1
