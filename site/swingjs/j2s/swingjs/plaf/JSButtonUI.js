...
if (this.isMenuSep) {
text=null;
}this.itemNode=$I$(1,"newDOMObject$S$S$SA",["li", this.id, Clazz.array(String, -1, [])]);
if (text == null  && icon == null  ) return this.itemNode;
$I$(2).setStyle(this.itemNode, "outline", "none");
this.menuAnchorNode=$I$(1,"newDOMObject$S$S$SA",["div", this.id + "_a", Clazz.array(String, -1, [])]);
if (type !== "_bar" ) {
