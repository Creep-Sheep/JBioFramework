...
$I$(36).getComponentAccessor$().revalidateSynchronously$java_awt_Component(this.editingComponent);
...
var selectAll=true;
if (event != null ) {
var componentPoint=$I$(6,"convertPoint$java_awt_Component$java_awt_Point$java_awt_Component",[this.tree, Clazz.new_([event.getX$(), event.getY$()],$I$(37,1).c$$I$I), this.editingComponent]);
...
var handler=Clazz.new_($I$(38,1).c$$java_awt_Component$java_awt_Component$java_awt_event_MouseEvent$java_awt_Component,[this, null, this.tree, activeComponent, event, focusedComponent]);
...
;Clazz.setTVer('3.3.1-v1');//Created 2021-05-28 11:34:09 Java2ScriptVisitor version 3.3.1-v1 net.sf.j2s.core.jar version 3.3.1-v1
