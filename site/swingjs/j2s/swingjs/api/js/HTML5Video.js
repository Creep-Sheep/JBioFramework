(function(){var P$=Clazz.newPackage("swingjs.api.js"),I$=[[0,'java.awt.Dimension','java.awt.image.BufferedImage','swingjs.api.js.HTML5Canvas','java.awt.event.ActionEvent','java.util.ArrayList','javax.swing.ImageIcon','java.nio.file.Files','java.io.File','javax.swing.JLabel','javax.swing.JDialog','javax.swing.BoxLayout','swingjs.api.js.HTML5Video','javax.swing.JPanel','javax.swing.JButton']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
/*i*/var C$=Clazz.newInterface(P$, "HTML5Video", null, null, 'swingjs.api.js.DOMNode');
...
var dialog=Clazz.new_($I$(10,1).c$$java_awt_Frame,[parent]);
...
p.add$java_awt_Component(C$.getControls(label));
...
), Clazz.new_(P$.HTML5Video$2.$init$,[this, {label:label,dialog:dialog,maxWidth:maxWidth,whenReady:whenReady,jsvideo:jsvideo}])), ["canplaythrough"]);
