...
C$.$fields$=[['Z',['isShifted','inPath','thinLine','clearing','unclipped'],'I',['constrainX','constrainY','width','height','initialState','lastx','lasty','nx','ny'],'O',['canvas','swingjs.api.js.HTML5Canvas','ctx','swingjs.api.js.HTML5CanvasContext2D','gc','java.awt.GraphicsConfiguration','currentStroke','java.awt.BasicStroke','currentClip','java.awt.Shape','alphaComposite','java.awt.AlphaComposite','font','java.awt.Font','hints','java.awt.RenderingHints','transform','java.awt.geom.AffineTransform','backgroundColor','java.awt.Color','fontTransform','java.awt.geom.AffineTransform','image','java.awt.image.BufferedImage','foregroundColor','java.awt.Color','rrect','java.awt.geom.RoundRectangle2D.Double','imageData','swingjs.api.js.HTML5CanvasContext2D.ImageData','buf8','int[]','shader','java.awt.Paint','clearColorSaved','java.awt.Color']]
...
var is=this.currentClip != null  && !this.currentClip.contains$D$D$D$D(x, y, w, h) ;
return is;
}, p$1);
...
this.currentClip=Clazz.new_($I$(10,1).c$$I$I$I$I,[x, y, width, height]);
}if (C$.debugClip) {
...
g.transform=Clazz.new_($I$(4,1).c$$java_awt_geom_AffineTransform,[this.transform]);
if (this.hints != null ) {
