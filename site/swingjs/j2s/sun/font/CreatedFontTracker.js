...
Clazz.newMeth(C$, 'init$',  function () {
if (C$.t == null ) {
$I$(2,"doPrivileged$java_security_PrivilegedAction",[(P$.CreatedFontTracker$TempFileDeletionHook$lambda1$||(P$.CreatedFontTracker$TempFileDeletionHook$lambda1$=(((P$.CreatedFontTracker$TempFileDeletionHook$lambda1||
...
$I$(4).t.setContextClassLoader$ClassLoader(null);
$I$(6).getRuntime$().addShutdownHook$Thread($I$(4).t);
return null;
});
})()
...
;Clazz.setTVer('3.3.1-v1');//Created 2021-01-27 21:35:04 Java2ScriptVisitor version 3.3.1-v1 net.sf.j2s.core.jar version 3.3.1-v1
