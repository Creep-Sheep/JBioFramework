...
p$1.setFRCTX.apply(this, []);
p$1.initPositions.apply(this, []);
var h0=-this.font.getFontMetrics$().getDescent$();
var h1=this.font.getFontMetrics$().getHeight$() + h0;
return Clazz.new_($I$(17,1).c$$D$D$D$D,[x + this.positions[start * 2], y + this.positions[start * 2 + 1] + h0 , this.positions[count * 2], this.positions[count * 2 + 1] + h1]);
}, p$1);
