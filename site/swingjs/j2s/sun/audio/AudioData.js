(function(){var P$=Clazz.newPackage("sun.audio"),I$=[[0,'javax.sound.sampled.AudioFormat',['javax.sound.sampled.AudioFormat','.Encoding'],'javax.sound.sampled.AudioSystem','java.io.ByteArrayInputStream']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
;Clazz.setTVer('3.3.1-v1');//Created 2021-01-14 18:18:20 Java2ScriptVisitor version 3.3.1-v1 net.sf.j2s.core.jar version 3.3.1-v1
