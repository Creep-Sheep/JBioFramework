(function(){var P$=Clazz.newPackage("sun.reflect.annotation"),I$=[[0,'java.util.ArrayList','java.lang.reflect.Method','java.util.HashMap','java.lang.reflect.Array','Enum','sun.reflect.annotation.AnnotationType','java.util.LinkedHashMap','java.util.Collections','java.lang.annotation.AnnotationFormatError','java.lang.annotation.Annotation',['sun.reflect.annotation.AnnotationParser','.JSAnnotationObject'],'java.lang.reflect.Proxy','sun.reflect.annotation.AnnotationInvocationHandler']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
return $I$(11).parseAnnotations$S$Class$Z(name, c, isMethod);
}, 1);

Clazz.newMeth(C$, 'annotationForMap$Class$java_util_Map',  function (type, memberValues) {
return $I$(12,"newProxyInstance$ClassLoader$ClassA$java_lang_reflect_InvocationHandler",[type.getClassLoader$(), Clazz.array(Class, -1, [type]), Clazz.new_($I$(13,1).c$$Class$java_util_Map,[type, memberValues])]);
}, 1);
...
C$.EMPTY_ANNOTATION_ARRAY=Clazz.array($I$(10), [0]);
};
;
...
if (result.put$O$O(klass, a) != null ) {
throw Clazz.new_($I$(9,1).c$$S,["Duplicate annotation for class: " + klass + ": " + a ]);
}}}
}return result;
}, 1);
...
;Clazz.setTVer('3.3.1-v4');//Created 2022-03-19 05:26:48 Java2ScriptVisitor version 3.3.1-v4 net.sf.j2s.core.jar version 3.3.1-v4
