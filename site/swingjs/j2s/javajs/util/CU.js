(function(){var P$=Clazz.newPackage("javajs.util"),I$=[[0,'java.util.Hashtable','javajs.util.PT','javajs.util.P3']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var blu=$I$(2).parseFloat$S(tokens[2]);
...
return C$.colorPtFromInt$I$javajs_util_P3(C$.getArgbFromString$S(colorName), null);
}, 1);
...
return C$.colorTriadToFFRGB$F$F$F(pt.x, pt.y, pt.z);
}, 1);
...
Clazz.newMeth(C$, 'rgbToHSL$javajs_util_P3$Z',  function (rgb, doRound) {
var r=rgb.x / 255;
var g=rgb.y / 255;
var b=rgb.z / 255;
