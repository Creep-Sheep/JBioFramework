(function(){var P$=Clazz.newPackage("javajs.util"),p$1={},I$=[[0,'javajs.util.P4','javajs.util.M3','javajs.util.A4','javajs.util.V3']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
var vA=$I$(4).newV$javajs_util_T3(x);
var vB=$I$(4).newV$javajs_util_T3(xy);
if (center != null ) {
...
var v=$I$(4).new3$F$F$F(q.q1, q.q2, q.q3);
if (v.length$() == 0 ) return $I$(4).new3$F$F$F(0, 0, 1);
v.normalize$();
return v;
}, 1);
...
}return $I$(3).newVA$javajs_util_V3$F(v, theta);
});
