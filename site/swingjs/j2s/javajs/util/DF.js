...
C$.$fields$=[[]
,['O',['formattingStrings','String[]','formatAdds','float[]','useNumberLocalization','Boolean[]']]]
...
var i=s.indexOf$S("E");
n=$I$(1,"parseInt$S",[s.substring$I(i + 1)]) + n;
var sf;
if (i < 0) {
sf="" + new Float(value).toString();
} else {
var f=$I$(1,"parseFloat$S",[s.substring$I$I(0, i)]);
if (f == 10  || f == -10  ) {
f/=10;
n+=(n < 0 ? 1 : -1);
