...
var abMagic=(n > 264 ? Clazz.array(Byte.TYPE, [n]) : C$.b264 == null  ? (C$.b264=Clazz.array(Byte.TYPE, [264])) : C$.b264);
try {
is.mark$I(n + 1);
var i=is.read$BA$I$I(abMagic, 0, n);
if (i < n) {
abMagic[0]=abMagic[257]=(0|0);
}} catch (e) {
if (Clazz.exceptionOf(e,"java.io.IOException")){
} else {
throw e;
...
return (bytes[0] != 0 && (bytes[257] & 255) == 117  && (bytes[258] & 255) == 115  && (bytes[259] & 255) == 116  && (bytes[260] & 255) == 97  && (bytes[261] & 255) == 114 );
}, 1);
