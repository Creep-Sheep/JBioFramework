...
), Clazz.new_(P$.SwingJSUtils$StateHelper$1.$init$,[this, {levelNext:levelNext,me:me,listener:listener,event:event,stateNext:stateNext}]))],$I$(2,1).c$$I$java_awt_event_ActionListener);
...
$I$(8).getInstance$().timeouts.remove$O(Integer.valueOf$I(this.b$['javajs.async.SwingJSUtils.Timeout'].id));
if ((this.b$['javajs.async.SwingJSUtils.Timeout'].state == 1)) {
this.b$['javajs.async.SwingJSUtils.Timeout'].state=2;
this.b$['javajs.async.SwingJSUtils.Timeout'].r.run$();
...
;Clazz.setTVer('3.3.1-v1');//Created 2021-10-03 19:41:53 Java2ScriptVisitor version 3.3.1-v1 net.sf.j2s.core.jar version 3.3.1-v1
