(function(){var P$=Clazz.newPackage("javajs.http"),p$1={},p$2={},I$=[[0,'java.util.HashMap','java.util.ArrayList',['javajs.http.SimpleHttpClient','.Request','.FormData'],'java.io.FileInputStream','javajs.http.SimpleHttpClient',['javajs.http.SimpleHttpClient','.Response'],'Thread','java.util.LinkedHashMap','java.net.URL','java.net.URLEncoder',['javajs.http.SimpleHttpClient','.Request'],'java.io.ByteArrayOutputStream','java.net.URI']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['hasFormBody'],'S',['method'],'O',['uri','java.net.URI','htHeaders','java.util.Map','queryData','java.util.List','+formData']]]
...
var data="";
if (this.queryData != null ) {
var htGetParams=Clazz.new_($I$(8,1));
for (var i=0; i < this.queryData.size$(); i++) {
var fd=this.queryData.get$I(i);
htGetParams.put$O$O(fd.getName$(), fd.getData$().toString());
}
for (var e, $e = htGetParams.entrySet$().iterator$(); $e.hasNext$()&&((e=($e.next$())),1);) {
data+=e.getKey$() + "=" + p$1.encodeURI$S.apply(this, [e.getValue$()]) ;
}
}return (data.length$() > 0 ? Clazz.new_([this.uri.toString() + "?" + data ],$I$(9,1).c$$S) : this.uri.toURL$());
}, p$1);
...
var exception=null;
try {
if (this.b$['javajs.http.SimpleHttpClient.Response'].method.equals$O("HEAD")) {
this.b$['javajs.http.SimpleHttpClient.Response'].state=this.$finals$.conn.getResponseCode$();
} else {
...
try {
this.b$['javajs.http.SimpleHttpClient.Response'].state=this.b$['javajs.http.SimpleHttpClient.Response'].conn.getResponseCode$();
