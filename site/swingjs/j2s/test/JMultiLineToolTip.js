(function(){var P$=Clazz.newPackage("test"),I$=[[0,'StringBuilder','java.awt.Color','javax.swing.border.EmptyBorder']],I$0=I$[0],$I$=function(i,n){return((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
;Clazz.setTVer('3.3.1-v1');//Created 2021-07-23 11:23:22 Java2ScriptVisitor version 3.3.1-v1 net.sf.j2s.core.jar version 3.3.1-v1
