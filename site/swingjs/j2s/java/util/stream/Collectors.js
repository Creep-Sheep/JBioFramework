...
)); return Clazz.new_(P$.Collectors$lambda3.$init$,[this, null])})($I$(10)), (P$.Collectors$lambda4$||(P$.Collectors$lambda4$=(((P$.Collectors$lambda4||
...
)); return Clazz.new_(P$.Collectors$lambda6.$init$,[this, null])})($I$(12)), (P$.Collectors$lambda7$||(P$.Collectors$lambda7$=(((P$.Collectors$lambda7||
...
)); return Clazz.new_(P$.Collectors$lambda9.$init$,[this, null])})($I$(14)), (P$.Collectors$lambda10$||(P$.Collectors$lambda10$=(((P$.Collectors$lambda10||
...
)); return Clazz.new_(P$.Collectors$lambda12.$init$,[this, null])})($I$(15)), (P$.Collectors$lambda13$||(P$.Collectors$lambda13$=(((P$.Collectors$lambda13||
...
for (var e, $e = m2.entrySet$().iterator$(); $e.hasNext$()&&((e=($e.next$())),1);) m1.merge$O$O$java_util_function_BiFunction(e.getKey$(), e.getValue$(), this.$finals$.mergeFunction);
...
/*lambda_E*/
Clazz.newMeth(C$, 'accept$O$O',  function (r, t) { return (this.$finals$.downstreamAccumulator.accept$O$O(r, this.$finals$.mapper.apply$O(t)));});
})()
...
a[0]+=this.$finals$.mapper.applyAsInt$O(t);
});
})()
...
(a[0]=Long.$add(a[0],(this.$finals$.mapper.applyAsLong$O(t))));
});
})()
...
$I$(1,"sumWithCompensation$DA$D",[a, this.$finals$.mapper.applyAsDouble$O(t)]);
a[2]+=this.$finals$.mapper.applyAsDouble$O(t);
});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$JA$O','accept$O$O'],  function (a, t) {
(a[0]=Long.$add(a[0],(this.$finals$.mapper.applyAsInt$O(t))));
...
$I$(1,"sumWithCompensation$DA$D",[a, this.$finals$.mapper.applyAsDouble$O(t)]);
++a[2];
a[3]+=this.$finals$.mapper.applyAsDouble$O(t);
});
})()
...
a[0]=this.$finals$.op.apply$O$O(a[0], t);
});
})()
...
a[0]=this.$finals$.op.apply$O$O(a[0], b[0]);
return a;
});
})()
...
)); return Clazz.new_(P$.Collectors$lambda52.$init$,[this, null])})($I$(18)), (P$.Collectors$lambda53$||(P$.Collectors$lambda53$=(((P$.Collectors$lambda53||
...
if (b.present) a.accept$O(b.value);
return a;
});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$OA$O','accept$O$O'],  function (a, t) {
a[0]=this.$finals$.op.apply$O$O(a[0], this.$finals$.mapper.apply$O(t));
});
})()
...
var key=$I$(21,"requireNonNull$O$S",[this.$finals$.classifier.apply$O(t), "element cannot be mapped to a null key"]);
var container=m.computeIfAbsent$O$java_util_function_Function(key, ((P$.Collectors$lambda59$60||
...
/*lambda_E*/
Clazz.newMeth(C$, 'apply$O',  function (k) { return (this.$finals$.downstreamSupplier.get$());});
})()
...
), Clazz.new_(P$.Collectors$lambda59.$init$,[this, {downstreamSupplier:downstreamSupplier,downstreamAccumulator:downstreamAccumulator,classifier:classifier}]));
...
intermediate.replaceAll$java_util_function_BiFunction(((P$.Collectors$lambda60$61||
...
/*lambda_E*/
Clazz.newMeth(C$, 'apply$O$O',  function (k, v) { return (this.$finals$.downstreamFinisher.apply$O(v));});
})()
...
var key=$I$(21,"requireNonNull$O$S",[this.$finals$.classifier.apply$O(t), "element cannot be mapped to a null key"]);
var resultContainer=m.computeIfAbsent$O$java_util_function_Function(key, ((P$.Collectors$lambda63$64||
...
), Clazz.new_(P$.Collectors$lambda63.$init$,[this, {classifier:classifier,downstreamSupplier:downstreamSupplier,downstreamAccumulator:downstreamAccumulator}]));
} else {
...
Clazz.newMeth(C$, ['accept$java_util_concurrent_ConcurrentMap$O','accept$O$O'],  function (m, t) {
var key=$I$(21,"requireNonNull$O$S",[this.$finals$.classifier.apply$O(t), "element cannot be mapped to a null key"]);
var resultContainer=m.computeIfAbsent$O$java_util_function_Function(key, ((P$.Collectors$lambda64$65||
...
), Clazz.new_(P$.Collectors$lambda64.$init$,[this, {classifier:classifier,downstreamSupplier:downstreamSupplier,downstreamAccumulator:downstreamAccumulator}]));
}if (downstream.characteristics$().contains$O($I$(8).IDENTITY_FINISH)) {
...
intermediate.replaceAll$java_util_function_BiFunction(((P$.Collectors$lambda65$66||
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$java_util_stream_Collectors_Partition$O','accept$O$O'],  function (result, t) { return (this.$finals$.downstreamAccumulator.accept$O$O(this.$finals$.predicate.test$O(t) ? result.forTrue : result.forFalse, t));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$java_util_stream_Collectors_Partition$java_util_stream_Collectors_Partition','apply$O$O'],  function (left, right) { return (Clazz.new_([this.$finals$.op.apply$O$O(left.forTrue, right.forTrue), this.$finals$.op.apply$O$O(left.forFalse, right.forFalse)],$I$(23,1).c$$O$O));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, 'get$',  function () { return (Clazz.new_([this.$finals$.downstream.supplier$().get$(), this.$finals$.downstream.supplier$().get$()],$I$(23,1).c$$O$O));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['apply$java_util_stream_Collectors_Partition','apply$O'],  function (par) { return (Clazz.new_([this.$finals$.downstream.finisher$().apply$O(par.forTrue), this.$finals$.downstream.finisher$().apply$O(par.forFalse)],$I$(23,1).c$$O$O));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$java_util_Map$O','accept$O$O'],  function (map, element) { return (map.merge$O$O$java_util_function_BiFunction(this.$finals$.keyMapper.apply$O(element), this.$finals$.valueMapper.apply$O(element), this.$finals$.mergeFunction));});
})()
), Clazz.new_(P$.Collectors$lambda72.$init$,[this, {mergeFunction:mergeFunction,keyMapper:keyMapper,valueMapper:valueMapper}]));
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$java_util_concurrent_ConcurrentMap$O','accept$O$O'],  function (map, element) { return (map.merge$O$O$java_util_function_BiFunction(this.$finals$.keyMapper.apply$O(element), this.$finals$.valueMapper.apply$O(element), this.$finals$.mergeFunction));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$java_util_IntSummaryStatistics$O','accept$O$O'],  function (r, t) { return (r.accept$I(this.$finals$.mapper.applyAsInt$O(t)));});
})()
), Clazz.new_(P$.Collectors$lambda77.$init$,[this, {mapper:mapper}])), (P$.Collectors$lambda78$||(P$.Collectors$lambda78$=(((P$.Collectors$lambda78||
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$java_util_LongSummaryStatistics$O','accept$O$O'],  function (r, t) { return (r.accept$J(this.$finals$.mapper.applyAsLong$O(t)));});
})()
), Clazz.new_(P$.Collectors$lambda80.$init$,[this, {mapper:mapper}])), (P$.Collectors$lambda81$||(P$.Collectors$lambda81$=(((P$.Collectors$lambda81||
...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$java_util_DoubleSummaryStatistics$O','accept$O$O'],  function (r, t) { return (r.accept$D(this.$finals$.mapper.applyAsDouble$O(t)));});
})()
), Clazz.new_(P$.Collectors$lambda83.$init$,[this, {mapper:mapper}])), (P$.Collectors$lambda84$||(P$.Collectors$lambda84$=(((P$.Collectors$lambda84||
