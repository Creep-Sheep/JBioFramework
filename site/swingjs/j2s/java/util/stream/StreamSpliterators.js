...
/*lambda_E*/
Clazz.newMeth(C$, 'accept$O',  function (t) {
if (this.b$['java.util.stream.StreamSpliterators.DistinctSpliterator'].seen.putIfAbsent$O$O(p$2.mapNull$O.apply(this.b$['java.util.stream.StreamSpliterators.DistinctSpliterator'], [t]), Boolean.TRUE) == null ) {
