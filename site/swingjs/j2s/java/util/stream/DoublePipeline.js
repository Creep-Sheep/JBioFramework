...
/*lambda_E*/
Clazz.newMeth(C$, ['accept$D','accept$O'],  function (i) { return (this.b$['java.util.stream.DoublePipeline$5$1'].downstream.accept$D(i));});
})()
...
this.$finals$.combiner.accept$O$O(left, right);
return left;
});
})()
