...
var t=this.b$['java.util.concurrent.ScheduledThreadPoolExecutor'].todo.remove$O(Integer.valueOf$I(this.$finals$.id[0]));
if (t != null ) {
...
;Clazz.setTVer('3.3.1-v1');//Created 2021-02-04 10:18:56 Java2ScriptVisitor version 3.3.1-v1 net.sf.j2s.core.jar version 3.3.1-v1
