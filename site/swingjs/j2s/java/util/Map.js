...
return (P$.Map$Entry$lambda1$||(P$.Map$Entry$lambda1$=(((P$.Map$Entry$lambda1||
...
/*lambda_E*/
Clazz.newMeth(C$, ['compare$java_util_Map_Entry$java_util_Map_Entry','compare$O$O'],  function (c1, c2) { return (c1.getKey$().compareTo$O(c2.getKey$()));});
})()
), Clazz.new_(P$.Map$Entry$lambda1.$init$,[this, null])))));
}, 1);

Clazz.newMeth(C$, 'comparingByValue$',  function () {
return (P$.Map$Entry$lambda2$||(P$.Map$Entry$lambda2$=(((P$.Map$Entry$lambda2||
...
/*lambda_E*/
Clazz.newMeth(C$, ['compare$java_util_Map_Entry$java_util_Map_Entry','compare$O$O'],  function (c1, c2) { return (c1.getValue$().compareTo$O(c2.getValue$()));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['compare$java_util_Map_Entry$java_util_Map_Entry','compare$O$O'],  function (c1, c2) { return (this.$finals$.cmp.compare$O$O(c1.getKey$(), c2.getKey$()));});
})()
...
/*lambda_E*/
Clazz.newMeth(C$, ['compare$java_util_Map_Entry$java_util_Map_Entry','compare$O$O'],  function (c1, c2) { return (this.$finals$.cmp.compare$O$O(c1.getValue$(), c2.getValue$()));});
})()
