...
/*lambda_E*/
Clazz.newMeth(C$, 'apply$O',  function (e) { return (this.b$['java.util.Collections.CheckedCollection'].typeCheck$O.apply(this.b$['java.util.Collections.CheckedCollection'], [this.$finals$.operator.apply$O(e)]));});
})()
