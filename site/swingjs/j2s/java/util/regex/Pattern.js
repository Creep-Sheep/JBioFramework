(function(){var P$=Clazz.newPackage("java.util.regex"),p$1={},I$=[[0,'java.util.regex.Matcher','java.util.ArrayList','StringBuilder','swingjs.JSUtil','java.util.HashMap','java.util.stream.StreamSupport','java.util.Spliterators']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['compiled'],'I',['flags','capturingGroupCount','cursor'],'S',['pattern'],'O',['namedGroups','java.util.Map','regexp','java.util.regex.Matcher.RegExp']]
...
}return Clazz.new_($I$(1,1).c$$java_util_regex_Pattern$CharSequence,[this, input]);
});
...
var matchList=Clazz.new_($I$(2,1));
...
this.regexp=C$.newRegExp$S$S(this.pattern, C$.getFlags$I(this.flags | -2147483648));
this.compiled=true;
}, p$1);
...
Clazz.newMeth(C$, 'newRegExp$S$S',  function (pattern, flags) {
...
if (this.namedGroups == null ) this.namedGroups=Clazz.new_($I$(5,1).c$$I,[2]);
...
/*lambda_E*/
Clazz.newMeth(C$, ['test$S','test$O'],  function (s) { return (this.b$['java.util.regex.Pattern'].matcher$CharSequence.apply(this.b$['java.util.regex.Pattern'], [s]).find$());});
})()
