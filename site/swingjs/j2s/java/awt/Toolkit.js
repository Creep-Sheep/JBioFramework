(function(){var P$=Clazz.newPackage("java.awt"),I$=[[0,'java.awt.AWTEventMulticaster','java.util.HashMap','sun.awt.NullComponentPeer','java.awt.Insets','swingjs.JSToolkit','java.awt.Cursor',['java.awt.Toolkit','.SelectiveAWTEventListener'],['java.awt.Toolkit','.ToolkitEventMulticaster'],'java.awt.event.AWTEventListener','java.awt.event.AWTEventListenerProxy','java.util.ArrayList','java.beans.PropertyChangeSupport']],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
selectiveListener=Clazz.new_($I$(7,1).c$$java_awt_event_AWTEventListener$J,[this, null, localL, eventMask]);
...
{
var la=$I$(1,"getListeners$java_util_EventListener$Class",[this.eventListener, Clazz.getClass($I$(9),['eventDispatched$java_awt_AWTEvent'])]);
var ret=Clazz.array($I$(9), [la.length]);
for (var i=0; i < la.length; i++) {
var sael=la[i];
var tempL=sael.getListener$();
ret[i]=Clazz.new_([sael.getEventMask$(), tempL],$I$(10,1).c$$J$java_awt_event_AWTEventListener);
}
return ret;
}});
...
{
var la=$I$(1,"getListeners$java_util_EventListener$Class",[this.eventListener, Clazz.getClass($I$(9),['eventDispatched$java_awt_AWTEvent'])]);
var list=Clazz.new_($I$(11,1).c$$I,[la.length]);
for (var i=0; i < la.length; i++) {
var sael=la[i];
if (Long.$eq((Long.$and(sael.getEventMask$(),eventMask)),eventMask )) {
list.add$O(Clazz.new_([sael.getEventMask$(), sael.getListener$()],$I$(10,1).c$$J$java_awt_event_AWTEventListener));
}}
return list.toArray$OA(Clazz.array($I$(9), [0]));
}});
...
return Clazz.new_($I$(12,1).c$$O,[toolkit]);
}, 1);
;
...
;Clazz.setTVer('3.3.1-v1');//Created 2021-05-28 11:33:53 Java2ScriptVisitor version 3.3.1-v1 net.sf.j2s.core.jar version 3.3.1-v1
