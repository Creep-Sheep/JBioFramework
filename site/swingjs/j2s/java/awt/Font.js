(function(){var P$=Clazz.newPackage("java.awt"),p$1={},I$=[[0,'swingjs.JSFontMetrics','java.awt.geom.AffineTransform','sun.font.AttributeValues','sun.font.EAttribute','java.awt.font.TextAttribute','swingjs.JSToolkit','sun.font.AttributeMap',['java.text.AttributedCharacterIterator','.Attribute'],['java.awt.geom.Point2D','.Float'],'sun.font.CoreMetrics','sun.font.FontLineMetrics','javajs.util.SB',['java.awt.geom.Rectangle2D','.Float']]],I$0=I$[0],$I$=function(i,n,m){return m?$I$(i)[n].apply(null,m):((i=(I$[i]||(I$[i]=Clazz.load(I$0[i])))),!n&&i.$load$&&Clazz.load(i,2),i)};
...
C$.$fields$=[['Z',['hasLayoutAttributes','createdFont','nonIdentityTx'],'F',['pointSize'],'I',['style','size','hash'],'S',['family','name'],'O',['fm','java.awt.FontMetrics','font2DHandle','sun.font.Font2DHandle','values','sun.font.AttributeValues','flmref','sun.font.FontLineMetrics']]
,['Z',['haveMasks'],'I',['RECOGNIZED_MASK','PRIMARY_MASK','SECONDARY_MASK','LAYOUT_MASK','EXTRA_MASK'],'O',['identityTx','java.awt.geom.AffineTransform','ssinfo','float[]']]]

Clazz.newMeth(C$, 'getFontMetrics$',  function () {
if (this.fm == null ) ((this.fm=Clazz.new_($I$(1,1)))).setFont$java_awt_Font(this);
return this.fm;
});
...
Clazz.newMeth(C$, 'getIdentityTx$',  function () {
return (C$.identityTx == null  ? (C$.identityTx=Clazz.new_($I$(2,1))) : C$.identityTx);
}, 1);
...
;C$.$init$.apply(this);
C$.initMasks$();
p$1.initFromValues$sun_font_AttributeValues.apply(this, [$I$(3).fromMap$java_util_Map$I(attributes, C$.RECOGNIZED_MASK)]);
}, 1);
...
C$.RECOGNIZED_MASK=$I$(3).MASK_ALL & ~$I$(3,"getMask$sun_font_EAttribute",[$I$(4).EFONT]);
C$.PRIMARY_MASK=$I$(3,"getMask$sun_font_EAttributeA",[Clazz.array($I$(4), -1, [$I$(4).EFAMILY, $I$(4).EWEIGHT, $I$(4).EWIDTH, $I$(4).EPOSTURE, $I$(4).ESIZE, $I$(4).ETRANSFORM, $I$(4).ESUPERSCRIPT, $I$(4).ETRACKING])]);
C$.SECONDARY_MASK=C$.RECOGNIZED_MASK & ~C$.PRIMARY_MASK;
C$.LAYOUT_MASK=$I$(3,"getMask$sun_font_EAttributeA",[Clazz.array($I$(4), -1, [$I$(4).ECHAR_REPLACEMENT, $I$(4).EFOREGROUND, $I$(4).EBACKGROUND, $I$(4).EUNDERLINE, $I$(4).ESTRIKETHROUGH, $I$(4).ERUN_DIRECTION, $I$(4).EBIDI_EMBEDDING, $I$(4).EJUSTIFICATION, $I$(4).EINPUT_METHOD_HIGHLIGHT, $I$(4).EINPUT_METHOD_UNDERLINE, $I$(4).ESWAP_COLORS, $I$(4).ENUMERIC_SHAPING, $I$(4).EKERNING, $I$(4).ELIGATURES, $I$(4).ETRACKING])]);
C$.EXTRA_MASK=$I$(3,"getMask$sun_font_EAttributeA",[Clazz.array($I$(4), -1, [$I$(4).ETRANSFORM, $I$(4).ESUPERSCRIPT, $I$(4).EWIDTH])]);
C$.haveMasks=true;
}, 1);
...
if (values.isNonDefault$sun_font_EAttribute($I$(4).EFONT)) {
...
}var font=attributes.get$O($I$(5).FONT);
if (font != null ) {
...
var at=values.isNonDefault$sun_font_EAttribute($I$(4).ETRANSFORM) ? Clazz.new_([values.getTransform$()],$I$(2,1).c$$java_awt_geom_AffineTransform) : Clazz.new_($I$(2,1));
...
at.preConcatenate$java_awt_geom_AffineTransform($I$(2).getTranslateInstance$D$D(0, trans));
at.scale$D$D(scale, scale);
}if (values.isNonDefault$sun_font_EAttribute($I$(4).EWIDTH)) {
...
var attributes=Clazz.array($I$(8), -1, [$I$(5).FAMILY, $I$(5).WEIGHT, $I$(5).WIDTH, $I$(5).SIZE, $I$(5).UNDERLINE, $I$(5).STRIKETHROUGH]);
return attributes;
});
...
(this.getFontMetrics$()).getMetrics$java_awt_geom_AffineTransform$O$O$FA(C$.getIdentityTx$(), frc.getAntiAliasingHint$(), frc.getFractionalMetricsHint$(), metrics);
...
return Clazz.new_($I$(13,1).c$$F$F$F$F,[0, -dec, width, asc + dec]);
});
...
(this.getFontMetrics$()).getMetrics$java_awt_font_FontRenderContext$FA(frc, metrics);
